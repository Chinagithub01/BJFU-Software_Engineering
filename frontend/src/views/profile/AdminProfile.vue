...
const statItems = computed(() => [
  { label: '总用户', value: summary.value.userCount },
  { label: '学生', value: summary.value.studentCount },
  { label: '教师', value: summary.value.teacherCount },
  { label: '课程', value: summary.value.courseCount },
  { label: '作业', value: summary.value.assignmentCount },
  { label: '提交', value: summary.value.submissionCount },
  { label: '互评', value: summary.value.reviewCount },
  { label: '待处理申诉', value: summary.value.pendingAppeals, warn: (summary.value.pendingAppeals || 0) > 0 }
])
